...
@Component({
  selector: 'app-trazabilidad-pta',
  templateUrl: './trazabilidad-pta.component.html',
  styleUrls: ['./trazabilidad-pta.component.css']
})
export class TrazabilidadPtaComponent implements OnInit {
  ...
  iniciarFormulario() {
    this.formularioTrazabilidadProceso = this.formBuilder.group({
      ...
      PresionGas1: [this.detalle ? this.detalle.PresionGas1 : null],
      PresionGas2: [this.detalle ? this.detalle.PresionGas2 : null]
    })
