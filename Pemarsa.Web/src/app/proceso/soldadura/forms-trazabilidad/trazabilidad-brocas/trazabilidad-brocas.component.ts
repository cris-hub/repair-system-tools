...
@Component({
  ...
  templateUrl: './trazabilidad-brocas.component.html',
  styleUrls: ['./trazabilidad-brocas.component.css']
})
export class TrazabilidadBrocasComponent implements OnInit {
  ...
  iniciarFormulario() {
    this.formularioTrazabilidadProceso = this.formBuilder.group({
      ...
      TamañoCortadoresId: [this.detalle ? this.detalle.TamañoCortadoresId : null],
      TipoFuenteId: [this.detalle ? this.detalle.TipoFuenteId : null],
